...
class Source(nn.Module):
    def __init__(self):
        ...
        self.fc1 = self.fc_1 = nn.Linear(in_features=32, out_features=8)
    ...
    def init_weights(self):
        ...
        for conv in [self.conv1, self.conv2, self.conv3]:
            ...
            ## TODO: DONE
            # im unsure if this is the right way to set the std
            nn.init.normal_(conv.weight, mean=0, std=sqrt(1 / (conv.kernel_size[0] * conv.kernel_size[1] * conv.in_channels)))
